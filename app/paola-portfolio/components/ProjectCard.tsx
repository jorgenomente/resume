...
export function ProjectCard({ title, subtitle, description, category, tags, image, link, index }: ProjectCardProps) {
  return (
    <motion.article
      initial="initial"
      whileInView="animate"
    ...
    >
      ...
      <div className="flex flex-col lg:flex-row gap-6 md:gap-8 justify-between">
        <div className="flex-1 space-y-3 md:space-y-4">
          ...
          <p className="text-[0.875rem] text-[#4a4a4a] leading-relaxed">{subtitle}</p>

          <p className="text-[0.938rem] md:text-[1rem] text-[#4a4a4a] leading-[1.65] max-w-xl">{description}</p>
          ...
          <motion.a
            ...
            whileHover="hover"
          >
            <motion.span variants={motionVariants.ctaHover}>Ver caso</motion.span>
            <motion.span

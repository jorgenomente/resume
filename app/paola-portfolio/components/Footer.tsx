          ...
          <div className="max-w-3xl mx-auto text-center space-y-10 md:space-y-12">
            ...
            <div className="pt-2">
              <a
                ...
                className="text-[1.5rem] md:text-[1.75rem] lg:text-[2rem] !text-white hover:!text-white font-medium tracking-tight transition-all duration-200 hover:opacity-90"
              >
            ...
            <div className="pt-6 md:pt-8">
              <a
                ...
                style={{ background: "#D4A89C" }}
              >
                <span className="text-[1rem] text-white font-medium tracking-tight">Conectar en LinkedIn</span>

        ...
        <div className="relative flex flex-col gap-6 p-7 pt-12 sm:p-8 sm:pt-14 md:flex-row md:items-center md:gap-10">
          <div className="flex flex-1 flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="/CV%20-%20Jorge%20Pulido.pdf" download="CV - Jorge Pulido CX.pdf" className="jorge-button">
                Descargar CV CX
              </a>
            </div>
          ...
          <SectionWrap>
            ...
            <div className="jorge-divider mt-3 pt-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Badge highlight>Soporte omnicanal</Badge>
                <Badge>Procesos y SLA</Badge>
                <Badge>IA para respuestas</Badge>
              </div>
            </div>
          </SectionWrap>
        </Card>

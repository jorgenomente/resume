...
import { 
  Sun, Mouse, ArrowUpRight, Search, Grid3X3, Minimize2, List,
  Workflow, Brain, LayoutDashboard, ChevronRight, Settings, Target,
  MessageCircleX, ShoppingCart, Users, Laptop, Mail, Linkedin, Phone, Menu, HeartHandshake
} from 'lucide-react';
...
import imgFrame484 from "figma:asset/66186e220726058b39ad5a758150970a5d9304df.png";
import imgFrame485 from "figma:asset/024323c82374fd791030e2239e6ab9958a9cd66d.png";
import imgFrame486 from "figma:asset/ab1798e0c4cce39c924013cdc3318bc4ae5cbdac.png";
import imgProfile from "figma:asset/10b4299ec2844579dcb41f731091753136678039.png";
import imgTeam from "figma:asset/92a0fa11fefa5195b99fedff2a1eaf0b61b6d64e.png";
...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Sequential method step activation on scroll
      if (methodRef.current) {
        ...
        setActiveMethodStep(Math.min(stepIndex, 3));
      }
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden lg:flex items-center gap-6">
              <a href="#proyectos" className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors">
                Proyectos
              </a>
              <a href="#metodo" className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors">
                Método
              </a>
              <a href="#servicios" className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors">
                Servicios
              </a>
              <a href="#contacto" className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors">
                Contacto
              </a>
            </nav>
          </div>
        ...
        {isMenuOpen && (
          ...
          >
            <nav className="flex flex-col p-4 gap-3">
              <a href="#proyectos" onClick={() => setIsMenuOpen(false)} className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors py-2">
                Proyectos
              </a>
              <a href="#metodo" onClick={() => setIsMenuOpen(false)} className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors py-2">
                Método
              </a>
              <a href="#servicios" onClick={() => setIsMenuOpen(false)} className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors py-2">
                Servicios
              </a>
              <a href="#contacto" onClick={() => setIsMenuOpen(false)} className="font-['Space_Mono'] text-sm text-[#f6f1e7] hover:text-[#f47dcf] transition-colors py-2">
                Contacto
              </a>
            </nav>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-br from-[rgba(244,125,207,0.15)] to-[rgba(199,185,255,0.15)] border border-[rgba(244,125,207,0.4)] rounded-2xl p-6 shadow-[0px_0px_20px_0px_rgba(244,125,207,0.2)] max-w-lg mx-auto">
              <p className="font-['Space_Grotesk'] font-medium text-sm sm:text-base text-[#13293d] leading-relaxed">
                ...
                <span className="font-bold">todo funciona, pero se desgasta</span>
                {' '}porque depende de{' '}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="font-['Space_Mono'] text-base md:text-lg text-[#13293d] max-w-2xl">
              Muestro <span className="font-bold">decisiones de diseño</span>, no solo estética visual.
            </p>
          </motion.div>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                >
                  ...
                  <p className="font-['Space_Mono'] text-sm text-[#13293d]">
                    {item.text}
                  </p>
                </motion.div>
              ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <p className="font-['Space_Grotesk'] font-medium text-lg bg-clip-text text-transparent bg-gradient-to-r from-[#f47dcf] to-[#c7b9ff] mb-6">
              Cuando el sistema está bien diseñado, estos son los cambios que se producen de forma consistente:
            </p>
          </motion.div>
          ...
          >
            Diseño para que las cosas, no solo se vean ordenadas, también para que funcionen mejor en la práctica.
          </motion.p>
        </div>
      </section>
              ...
              <div className="space-y-3 text-left">
                <div className="flex items-start gap-3">
                  ...
                  <p className="font-['Space_Mono'] text-base text-black">
                    <span className="font-bold">Audit</span> si no sabes qué está fallando.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#f47dcf] to-[#c7b9ff] flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="font-['Space_Mono'] text-base text-black">
                    <span className="font-bold">Ops</span> si necesitas sostener el orden en el día a día.
                  </p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#f47dcf] to-[#c7b9ff] flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <p className="font-['Space_Mono'] text-base text-black">
                    <span className="font-bold">Sprint</span> si el problema ya está claro y hay que destrabarlo rápido.
                  </p>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-[#13293d] border-t border-[#f47dcf]/20 py-8 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <p className="font-['Space_Mono'] text-sm text-[#f6f1e7]/60">
            © {new Date().getFullYear()} Paola Zerpa · Product Designer · Criterio para uso real
          </p>
        </div>
      </footer>
    </div>

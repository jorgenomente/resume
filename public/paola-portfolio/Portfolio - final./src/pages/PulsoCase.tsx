  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        {/* Context Section - Centered poetry */}
        <section className="container-portfolio section-spacing">
          <div className="max-w-xl mx-auto space-y-20 text-center">
            ...
            >
              <p className="text-[1.75rem] text-[#2a2a2a] leading-relaxed">
                Hay días en que la mente necesita espacio.
              </p>
            </motion.div>
            ...
            >
              <p className="text-[1.75rem] text-[#2a2a2a] leading-relaxed">
                PULSO no busca resolverlo todo.
              </p>
              <p className="text-[1.75rem] text-[#2a2a2a] leading-relaxed">
                Busca acompañar.
              </p>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1] relative">
          ...
          <div className="max-w-md mx-auto space-y-16">
            ...
            >
              <p className="text-[2rem] text-[#2a2a2a] leading-relaxed">
                No dicta rutinas.
              </p>
              <p className="text-[2rem] text-[#2a2a2a] leading-relaxed">
                No corrige.
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          <div className="grid lg:grid-cols-[280px_1fr] gap-16">
            ...
            >
              <p className="text-[0.75rem] text-[#8a8a8a] tracking-[0.05em] uppercase">
                Diseño
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  description: 'El bienestar emocional no necesita recordatorios.'
                },
                {
                  number: '02',
                  title: 'Sin métricas',
                  description: 'No todo debe medirse para tener valor.'
                },
                {
                  number: '03',
                  title: 'Sin compartir',
                  description: 'Lo que se escribe es íntimo.'
                }
              ].map((principle, index) => (
                <motion.div
                ...
                >
                  <p className="text-[0.75rem] text-[#8a8a8a] tracking-[0.05em] uppercase">
                    {principle.number} · Diseño
                  </p>
                  <div className="space-y-3">
                    <h3 className="text-[2rem] text-[#2a2a2a] leading-tight">
                      {principle.title}
                    </h3>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          <div className="max-w-xl mx-auto space-y-20 text-center">
            ...
            >
              ...
              <p className="text-[1.75rem] text-[#2a2a2a] leading-relaxed">
                PULSO invita simplemente a estar.
              </p>
            </motion.div>
            ...
            >
              <p className="text-[1.75rem] text-[#2a2a2a] leading-relaxed">
                A veces, lo más radical no es hacer más.
              </p>
              <p className="text-[1.75rem] text-[#2a2a2a] leading-relaxed">
                Es escribir.
              </p>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          ...
          >
            <h2 className="text-[3rem] text-[#2a2a2a] leading-tight tracking-wide">
              PULSO
            </h2>

...
import imgHero from "figma:asset/ece298d0ec2c16f10310d45724b276a6035cb503.png";
      ...
      <main className="pt-16">
            ...
            >
              <div className="space-y-4">
                ...
                <p className="text-[0.938rem] md:text-[1.125rem] text-[#4a4a4a] leading-[1.65]">
                  Herramienta interna que organiza procesos operativos fragmentados. 
                  El objetivo: que equipos reales trabajen mejor, más rápido y sin errores.
                </p>
              </div>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          ...
          >
            ...
            <h2 className="text-[2.25rem] text-[#2a2a2a] font-bold leading-tight tracking-tight">
              Debe reflejarlos.
            </h2>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          <div className="grid lg:grid-cols-[320px_1fr] gap-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              />
              <InsightBlock
                title="Flujos basados en roles reales"
                index={1}
              />
              <InsightBlock
                title="Jerarquía visual que prioriza acciones"
                index={2}
              />
              <InsightBlock
                title="Estados claros en cada etapa"
                index={3}
              />
              <InsightBlock
              ...
              />
              <InsightBlock
                title="Diseño para velocidad operativa"
                index={5}
              />
            </div>
          </div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="space-y-3">
                ...
                <p className="text-[0.875rem] text-[#6b6b6b]">
                  Qué cambia: Trazabilidad total, responsabilidad clara.
                </p>
              </div>
            </div>
          </motion.div>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="space-y-4">
                <div className="bg-[#f5f4f0] rounded-lg aspect-video" />
                <div className="space-y-2">
                  <p className="text-[1rem] text-[#2a2a2a]">Dashboard principal</p>
                  <p className="text-[0.875rem] text-[#6b6b6b]">
              ...
              <div className="space-y-4">
                <div className="bg-[#f5f4f0] rounded-lg aspect-video" />
                <div className="space-y-2">
                  <p className="text-[1rem] text-[#2a2a2a]">Gestión de pedidos</p>
                  <p className="text-[0.875rem] text-[#6b6b6b]">
              ...
              <div className="space-y-4">
                <div className="bg-[#f5f4f0] rounded-lg aspect-video" />
                <div className="space-y-2">
                  <p className="text-[1rem] text-[#2a2a2a]">Control de inventario</p>
                  <p className="text-[0.875rem] text-[#6b6b6b]">
                    Seguimiento de stock y alertas automáticas.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-[#f5f4f0] rounded-lg aspect-video" />
                <div className="space-y-2">
                  <p className="text-[1rem] text-[#2a2a2a]">Asignación de tareas</p>
                  <p className="text-[0.875rem] text-[#6b6b6b]">
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          <div className="grid lg:grid-cols-[320px_1fr] gap-12">
            ...
            >
              ...
              <p className="text-[1rem] text-[#D4A89C] font-medium">Onboarding de nuevos operadores reducido a la mitad</p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="container-portfolio section-spacing border-t border-[#e8e6e1]">
          ...
          >
            <p className="text-[1.25rem] text-[#2a2a2a] leading-relaxed">
              NODUX muestra mi forma de diseñar sistemas: entender el problema operativo real, 
              diseñar arquitectura escalable y priorizar claridad sobre decoración.
            </p>
